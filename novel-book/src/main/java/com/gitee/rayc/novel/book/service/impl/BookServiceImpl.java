package com.gitee.rayc.novel.book.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.gitee.rayc.novel.book.cache.*;
import com.gitee.rayc.novel.book.entity.BookChapter;
import com.gitee.rayc.novel.book.entity.BookComment;
...
import com.gitee.rayc.novel.book.mapper.BookCommentMapper;
import com.gitee.rayc.novel.book.mapper.BookContentMapper;
import com.gitee.rayc.novel.book.mapper.BookInfoMapper;
import com.gitee.rayc.novel.book.service.BookService;
import com.gitee.rayc.novel.book.utils.RocketUtils;
import com.gitee.rayc.novel.core.api.dto.req.book.*;
import com.gitee.rayc.novel.core.api.dto.resp.book.*;
...
import com.gitee.rayc.novel.core.data.anno.Key;
import com.gitee.rayc.novel.core.data.anno.Lock;
...
public class BookServiceImpl implements BookService {
    ...
    private final RocketUtils rocketUtils;
    ...
    public RestResp<Void> saveComment(@Key(expr = "#{userId + '::' + bookId}") BookCommentReqDto dto) {
        ...
        if (bookCommentMapper.selectCount(queryWrapper) > 0) {
            // 用户已发表评论
            return RestResp.fail(RespCodeEnum.USER_COMMENTED);
        }
    ...
    public RestResp<BookCommentRespDto> listNewestComments(Long bookId) {
        ...
        if (commentTotal > 0) {
            ...
            List<UserInfoRespDto> userInfos = userRpcService.listUserInfoByIds(userIds).getData();
    ...
    public RestResp<Void> saveBook(BookAddReqDto dto) {
        ...
        if (bookInfoMapper.selectCount(queryWrapper) > 0) {
            return RestResp.fail(RespCodeEnum.AUTHOR_BOOK_NAME_EXIST);
        }
    ...
    public RestResp<Void> saveBookChapter(ChapterAddReqDto dto) {
        ...
        if (!Objects.equals(bookInfo.getAuthorId(), dto.getAuthorId())) {
            return RestResp.fail(RespCodeEnum.USER_UN_AUTH);
        }
        // 1) 保存章节相关信息到小说章节表
        //  a) 查询最新章节号
        int chapterNum = 0;
    ...
    public RestResp<BookContentAboutRespDto> getBookContentAbout(Long chapterId) {
        log.debug("userId:{}", AuthContext.getUserId());
        // 查询章节信息
