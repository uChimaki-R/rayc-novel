package com.gitee.rayc.novel.author.interceptor;

import com.gitee.rayc.novel.author.cache.AuthorInfoCacheManager;
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (Objects.isNull(authorInfo)) {
            // 作家账号不存在，无权访问作家专区
            throw new BusinessException(RespCodeEnum.USER_UN_AUTH);
        }

        // 设置作家ID到当前线程
        AuthContext.setAuthorId(authorInfo.getId());
        // 设置 userId 到当前线程
